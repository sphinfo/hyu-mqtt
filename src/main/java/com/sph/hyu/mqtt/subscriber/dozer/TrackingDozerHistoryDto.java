...
public class TrackingDozerHistoryDto {
	...
	@JsonProperty("dz_bdy_lttd")
	private double lng ;			//경도
	@JsonProperty("dz_bdy_lgtd")
	private double lat ;			//위도
	private double matLng ;			//경도
	private double matLat ;			//위도
	@JsonProperty("dz_bdy_attd")
	...
	@JsonProperty("dz_bdy_x_pose")
	private double roll;
	@JsonProperty("dz_bdy_y_pose")
