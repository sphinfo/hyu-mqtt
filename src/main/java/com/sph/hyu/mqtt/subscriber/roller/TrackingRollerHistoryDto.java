...
public class TrackingRollerHistoryDto {
	...
	@JsonProperty("rlr_drm_z_pose")
	private float heading;
	@JsonProperty("rlr_drm_vel")
	private float speed ;			//속도
	private String workType ;		//업무 종류(상차/하차)
	private String assetType="09";	//차량종류(덤프, 굴삭기)
